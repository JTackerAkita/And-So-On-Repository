...
fig_category <- ggplot(
  ...
  labs(
    title = "Target lexical bundle categories by group",
    x = "Group",
...
fig_heatmap <- ggplot(
  ...
  labs(
    title = "Heatmap of target lexical bundle categories by group",
    x = "Bundle category",
    y = "Group",
...
fig_top15 <- ggplot(
  ...
  coord_flip() +
  labs(
    title = "Top 15 target lexical bundles overall",
    x = "Lexical bundle",
...
fig_top10_group <- ggplot(
  ...
  labs(
    title = "Top 10 target lexical bundles by group",
    x = "Lexical bundle",
    y = "Normalized frequency per 100,000 words"
  ) +
  theme_bw(base_size = 14) +
